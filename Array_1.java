...
public boolean no23(int[] nums) {
	  boolean c2 = (nums[0] == 2) || (nums[1] == 2);
	  boolean c3 = (nums[0] == 3) || (nums[1] == 3);
	  if (!(c2 || c3)) {
	    return true;
	  }
	  else return false;
...
public boolean double23(int[] nums) {
	  ...
	  boolean t2 = (nums[0] == 2) && (nums[1] == 2);
	  boolean t3 = (nums[0] == 3) && (nums[1] == 3);
...
public int start1(int[] a, int[] b) {
	  ...
	  else if (a[0] == 1 && b[0] == 1) return 2;
	  else if ((b[0] == 1)|| (a[0] == 1)) return 1;
	  else return 0;
	}
...
public int maxTriple(int[] nums) {
	  ...
	  for (int i = 1; i < nums.length; i++) {
	    if ((i == nums.length-1 || i == nums.length/2) && (nums[i] > maxi)) {
	      maxi = nums[i];
	    }
	  }
	  return maxi;
...
public boolean unlucky1(int[] nums) {
	  boolean flag = false;
	  if (nums.length < 2) return flag;
	  else {
	    for (int i = 0; i < 2; i++) {
	    if (nums[i] == 1 && nums[i+1] == 3) flag = true;
	  }
	  if (nums[nums.length-2]==1 && nums[nums.length-1]==3) flag = true;
	  return flag;
	  }
	}
